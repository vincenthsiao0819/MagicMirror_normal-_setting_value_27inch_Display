...
Module.register("calendar", {
	...
	getDom () {
		...
		events.forEach((event, index) => {
			...
			titleWrapper.innerHTML = "<div class='title-text' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>" + CalendarUtils.shorten(transformedTitle, this.config.maxTitleLength, this.config.wrapEvents, this.config.maxTitleLines) + repeatingCountTitle + "</div>";
